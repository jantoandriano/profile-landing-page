...
export const projects: Project[] = [
  { num: "01", tag: "Mobile · Flutter", title: "Flutter Mobile App", org: "Personal Project", desc: "Self-directed dive into Flutter and native mobile patterns — widget composition, state management, and platform APIs — as a step toward broader client-side engineering.", stack: "Flutter · Dart", status: "ongoing", link: "https://github.com/jantoandriano/tmbd_app" },
